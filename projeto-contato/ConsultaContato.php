...
class ConsultaContato extends ConsultaPadrao {
    ...
    protected function getTabelaConsulta() {
        return 'contato';
    }
        ...
        return '<div class="modal" id="modal">
                    <div class="modal-content">
                        ...
                        <form id="form" class="modal-form">
                            <input type="hidden" id="chave" class="modal-field" placeholder="Id">
    ...
    protected function getScripsJavaScript(){
        $oScriptPadrao = "";//parent::getScripsJavaScript();
        
        $oScriptContato = "<script src=\"js/ConsultaContato.js\" defer></script>";
        
        return $oScriptPadrao . $oScriptContato;
    }
}

...
class RelatoriosCliente extends RelatorioPadrao {
    ...
    protected function getAcoesInclusao(){
        return '<section class="acoes">
                    <button type="button" class="button blue mobile" id="incluirDados">Clientes</button>
                    <button type="button" class="button green" id="consultarDados">Contatos</button>
                    <button type="button" class="button red" id="limparDados">Produtos</button>
                    <button type="button" class="button blue mobile" id="limparDados">Vendas</button>
                </section>';
    }
}

new RelatoriosCliente();
